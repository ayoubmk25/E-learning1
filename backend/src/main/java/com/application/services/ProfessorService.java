...
public class ProfessorService 
{
	...
	{
		Professor prof = professorRepo.findByEmail(professor.getEmail());

		prof.setProfessorid(prof.getProfessorid());
		prof.setProfessorname(prof.getProfessorname());
		prof.setDepartment(prof.getDepartment());
		prof.setExperience(prof.getExperience());
		prof.setMobile(prof.getMobile());
		prof.setDegreecompleted(prof.getDegreecompleted());
